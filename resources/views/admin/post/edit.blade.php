...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <form action="{{ route('admin.posts.update', $post) }}" method="post" enctype="multipart/form-data" class="mt-10">
    ...
    @csrf
        ...
        <x-button style="display : block !important;" class="mt-5">Modifier le post</x-button>
